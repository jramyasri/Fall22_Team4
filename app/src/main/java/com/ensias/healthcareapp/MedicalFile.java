...
public class MedicalFile extends AppCompatActivity {
    ...
    private CardView createNewFicheButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createNewFicheButton = findViewById(R.id.floatingActionButton);
        findViewById(R.id.ivBack).setOnClickListener(view -> finish());
        createNewFicheButton.setOnClickListener(view -> openPatientFiche());
